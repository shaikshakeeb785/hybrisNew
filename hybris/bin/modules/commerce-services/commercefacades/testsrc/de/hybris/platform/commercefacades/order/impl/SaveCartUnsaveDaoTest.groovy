...
class SaveCartUnsaveDaoTest  extends AbstractCommerceFacadesSpockTest{
	...
	def EXP_DAYS = 30L
	def EXP_MS = EXP_DAYS * 24 * 60 * 60 * 1000;
	...
	def "Test Unsave Dao For Expired Saved Cart"() {
		...
		saveCartData1.expirationTime.getTime() >= saveCartData1.saveTime.getTime() + EXP_MS
		saveCartData2.expirationTime.getTime() >= saveCartData2.saveTime.getTime() + EXP_MS

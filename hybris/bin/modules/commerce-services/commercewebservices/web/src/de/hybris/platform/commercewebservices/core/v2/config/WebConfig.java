...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "commercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "commercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "commercewebservices.oauth2.tokenUrl";

	private static final String DESC = "commercewebservices.v2.description";
	private static final String TITLE = "commercewebservices.v2.title";
	private static final String VERSION = "commercewebservices.v2.version";
	private static final String LICENSE = "commercewebservices.v2.license";
	private static final String LICENSE_URL = "commercewebservices.v2.license.url";

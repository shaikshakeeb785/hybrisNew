 ...
 *
 */
package de.hybris.platform.commercewebservicestests.test.groovy.webservicetests.v2.spock.address
...
class AddressTest extends AbstractUserTest {
	...
	def "Address gets rejected by service when request: #requestFormat and response: #responseFormat"() {
		...
		//Below block of code should be removed after fix of DefaultCisAddressVerificationService in cisavs extension
		assumeTrue(ConfigUtil.getPlatformConfig(this.class).getExtensionInfo("cisavs") == null)
		//End of block

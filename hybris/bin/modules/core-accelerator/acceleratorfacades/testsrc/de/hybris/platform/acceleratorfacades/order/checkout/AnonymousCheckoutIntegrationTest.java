...
public class AnonymousCheckoutIntegrationTest extends BaseCommerceBaseTest
{
	...
	public void testAnonymousCheckout() throws Exception
	{
		...
		try
		{
			...
			verifyOrder(order, guestEmail);
		}
		catch (NoSuchProcessDefinitionException exception)
		{
			LOG.warn(String.format("Unable to complete checkout process and place order due to missing process [%s]",
	...
	protected void verifyOrder(final OrderData order, final String guestEmail) throws DuplicateUidException
	{

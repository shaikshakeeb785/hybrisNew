			...
			<div class="yCmsContentSlot login-left-content-slot">
				<div class="yCmsComponent login-left-content-component">
					<div class="login-section">
						...
						<form:form action="${bindUrl}" method="post" modelAttribute="verificationCodeForm">
							...
							<div class="note-mobile-binding">
						            <spring:theme var="bindMobileNoteHtml" code="mobile.binding.note.text" htmlEscape="false"/>
						            <label class="control-label uncased">
						                ${ycommerce:sanitizeHTML(bindMobileNoteHtml)}
						            </label>
					         </div>

				...
				<div class="yCmsComponent login-left-content-component">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<form:form method="post" modelAttribute="verificationCodeForm">
								...
								<div class="note-mobile-unbinding">
						            <spring:theme var="unbindMobileNoteHtml" code="mobile.unbinding.note.text" htmlEscape="false"/>
						            <label class="control-label uncased">
						                ${ycommerce:sanitizeHTML(unbindMobileNoteHtml)}
						            </label>
					             </div>

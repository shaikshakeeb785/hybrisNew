...
public class EventMappingValidValidator implements ConstraintValidator<EventMappingValid, Object>
{
	...
	protected boolean validPropertyMapping(final Class reflectedClass, final EventPropertyConfigurationModel eventPC)
	{
		...
		{
			LOGGER.error("EventPropertyConfiguration for the Class : {} , is not valid. PropertyMapping : {}, is empty or has invalid format.",
	...
	protected boolean existsAttribute(final Class reflectedClass, final String reference, final String delimiter)
	{
		...
		if (!method.isPresent())
		{
			LOGGER.error("PropertyMapping of an EventPropertyConfiguration is not valid. Property : {}, does not exist in Class : {}.",
	...
	protected boolean eventPropertyConfigIsValid(final EventPropertyConfigurationModel eventPC)
	{
		...
		{
			LOGGER.error("EventPropertyConfiguration for the Class : {} , is not valid. Key of PropertyMapping : {}, has invalid characters.",
		...
		{
			LOGGER.error("EventPropertyConfiguration for the Class : {} , is not valid. Value of PropertyMapping : {}, has invalid characters.",

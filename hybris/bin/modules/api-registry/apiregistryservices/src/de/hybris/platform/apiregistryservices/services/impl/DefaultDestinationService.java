...
public class DefaultDestinationService<T extends AbstractDestinationModel> implements DestinationService
{
	...
	@Override
	public void testDestinationUrl(final ConsumedDestinationModel consumedDestination) throws DestinationNotFoundException
	{
		try
		{
			...
			final RestTemplate restTemplate = getRestTemplate(consumedDestination);
			final ResponseEntity<String> response = restTemplate
					.exchange(consumedDestination.getUrl(), HttpMethod.GET, httpEntity, String.class);
	...
	protected RestTemplate getRestTemplate(final ConsumedDestinationModel consumedDestination) throws CredentialException
	{
		final DefaultRestTemplateFactory defaultRestTemplateFactory = new DefaultRestTemplateFactory();
		return defaultRestTemplateFactory.getRestTemplate(consumedDestination);
	}

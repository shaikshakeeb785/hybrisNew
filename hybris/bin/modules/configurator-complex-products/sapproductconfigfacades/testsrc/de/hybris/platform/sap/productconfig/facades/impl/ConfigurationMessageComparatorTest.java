...
public class ConfigurationMessageComparatorTest
{
	...
	public void testCompareDiscountMessagesConsideringPromoTypeNoDiscountMessage()
	{
		...
		final ProductConfigMessageData m1 = createMessage("Message 2", ProductConfigMessagePromoType.PROMO_OPPORTUNITY, null);
		assertEquals(ConfigurationMessageComparator.NO_MATCHING_CONDITION, classUnderTest.compareDiscountMessagesConsideringPromoType(m2, m1));
	}
	...
	public void testCompareStandardMessagesConsideringSeverityNoStandardMessage()
	{
		...
		final ProductConfigMessageData m1 = createMessage("Message 2", null, ProductConfigMessageUISeverity.INFO);
		assertEquals(ConfigurationMessageComparator.NO_MATCHING_CONDITION, classUnderTest.compareStandardMessagesConsideringSeverity(m2, m1));
	}
	...
	public static ProductConfigMessageData createMessage(final String message, final ProductConfigMessagePromoType type, final ProductConfigMessageUISeverity severity)
	{

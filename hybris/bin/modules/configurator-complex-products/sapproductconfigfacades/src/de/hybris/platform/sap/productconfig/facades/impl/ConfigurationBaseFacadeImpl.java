...
public class ConfigurationBaseFacadeImpl
{
	 ...
	 * <br>
	 * Consider to override in case e.g. the support for analytics is desired for multilevel products on root item level (on
	 * sub item level, analytics won't be displayed in any case). In this case change
	...
	/**
	 * This method is used to apply populators which translate {@link ConfigModel} into {@link ConfigurationData}. In this
	 * default implementation, {@link SolvableConflictPopulator } is applied.
	 *
	 * @param configData
	 * @param configModel
	 */
	 ...
	 *                           used to map the cstic model(serice layer object) to cstsic data (facade layer object) and
	 *                           vice versa
	 */
	@Required
	 ...
	 *                              only if <code>true</code> similar variants will be searched during interactive
	 ...
	 *                          maps the messages from model to data for the configuration, characteristics and

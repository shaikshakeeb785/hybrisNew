...
public class PersistenceConfigurationAbstractOrderIntegrationStrategyImplTest
{
	...
	public void testUpdateOrderEntryOnUpdate()
	{
		...
		verify(externalConfigurationAccess, never()).setExternalConfiguration(EXT_CONFIG, mockOrderEntry);
	}
	...
	public void testPrepareForOrderReplication()
	{
		...
		verify(externalConfigurationAccess, atLeastOnce()).setExternalConfiguration(EXT_CONFIG, mockOrderEntry);
	}

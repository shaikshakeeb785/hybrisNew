...
public class FrauddetectionTest extends ServicelayerTransactionalTest
{
			...
			final ProductModel product) throws Exception //NOPMD
	{
		...
		if (null != product)
		{
			cartService.addNewEntry(cart, product, 4, null);
		}
		...
		if (country1 != null)
		{
			deliveryAddress.setCountry(commonI18NService.getCountry(country1));
		}
		...
		if (country2 != null)
		{
			deliveryAddress.setCountry(commonI18NService.getCountry(country2));
		}

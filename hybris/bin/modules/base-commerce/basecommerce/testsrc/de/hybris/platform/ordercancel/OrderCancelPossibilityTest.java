...
public class OrderCancelPossibilityTest extends AbstractOrderCancelTest
{
	...
	/**
	 * Gets the list of denial reasons
	 *
	 * @return the list of denial reasons
	 */
	protected DefaultOrderCancelDenialReason[] getReasons()
	{
		return new DefaultOrderCancelDenialReason[] { singleCancelRequestDenialStrategyReason,
				defaultRequestOriginDenialStrategyReason, partialCancelRulesViolationStrategyReason, orderStateDenialStrategyReason,
				sentToWarehouseDenialStrategyReason, shippingDenialStrategyReason };
	}
	 ...
	 */
	private void injectDenialReasons(final DefaultOrderCancelService orderCancelService)
	{
		final Map<String, DefaultOrderCancelDenialReason> reasonsMap = new HashMap<String, DefaultOrderCancelDenialReason>();

		for (final DefaultOrderCancelDenialReason reason : getReasons())
		{

 ...
 */
package de.hybris.platform.b2bordermanagementfacades.jalo;
...
import de.hybris.platform.b2bordermanagementfacades.constants.B2bordermanagementfacadesConstants;
 ...
 */
public class B2bordermanagementfacadesManager extends GeneratedB2bordermanagementfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(B2bordermanagementfacadesManager.class);
	 ...
	 */
	public static B2bordermanagementfacadesManager getInstance()
	{
		return (B2bordermanagementfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2bordermanagementfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bordermanagementfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of B2bordermanagementfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of B2bordermanagementfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of B2bordermanagementfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}

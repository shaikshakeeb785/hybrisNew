...
class GetExpandSupportIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static def EXPAND_SUPPORT_IO = 'ExpandSupport'
    private static def USER = 'expandTester'
    private static def PASSWORD = 'retset'
    private static def PRODUCT_1 = 'product1'
    private static def PRODUCT_2 = 'product2'
    private static def CATALOG = 'expandTestCatalog'
    private static def CATALOG_VERSION = 'expandTestCatalogVersion'
    private static def CURRENCY_ISOCODE = 'expandTestEUR'
    ...
    def 'entities are expanded when $expand for collection'() {
        ...
        IntegrationTestUtil.importImpEx(
                ...
                "                      ; $USER             ; *:$PASSWORD ; integrationadmingroup,integrationservicegroup")

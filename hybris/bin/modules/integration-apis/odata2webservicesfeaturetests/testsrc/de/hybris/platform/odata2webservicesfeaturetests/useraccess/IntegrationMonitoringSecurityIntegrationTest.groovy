...
class IntegrationMonitoringSecurityIntegrationTest extends ServicelayerSpockSpecification {
    ...
    def cleanupSpec() {
        ...
        IntegrationTestUtil.remove EmployeeModel, {it.uid == MONITOR_ADMIN_USER}
    }
    ...
    def "GET /#service returns #status for #user"() {
        ...
        'InboundIntegrationMonitoring'  | ADMIN_USER         | HttpStatusCodes.NOT_FOUND
        'InboundIntegrationMonitoring'  | MONITOR_USER       | HttpStatusCodes.FORBIDDEN
        ...
        'OutboundIntegrationMonitoring' | ADMIN_USER         | HttpStatusCodes.NOT_FOUND
        'OutboundIntegrationMonitoring' | MONITOR_USER       | HttpStatusCodes.FORBIDDEN

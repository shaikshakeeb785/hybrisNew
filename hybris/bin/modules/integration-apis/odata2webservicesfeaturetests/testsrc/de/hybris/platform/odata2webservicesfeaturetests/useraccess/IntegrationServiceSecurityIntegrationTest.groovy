...
class IntegrationServiceSecurityIntegrationTest extends ServicelayerSpockSpecification {
    ...
    def cleanupSpec() {
        ...
        IntegrationTestUtil.remove EmployeeModel, { it.uid == ADMIN_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == MONITOR_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == SERVICE_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == CREATE_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == VIEW_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == DELETE_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == ADMIN_MONITOR_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == ADMIN_SERVICE_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == ADMIN_OUTBOUNDSYNC_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == ADMIN_OUTBOUNDSYNC_MONITOR_USER }
        IntegrationTestUtil.remove EmployeeModel, { it.uid == ADMIN_SERVICE_OUTBOUNDSYNC_MONITOR_USER }
    }

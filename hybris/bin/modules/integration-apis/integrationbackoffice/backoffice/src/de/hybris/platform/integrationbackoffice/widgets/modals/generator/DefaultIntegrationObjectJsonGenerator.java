...
public class DefaultIntegrationObjectJsonGenerator implements IntegrationObjectJsonGenerator
{
	...
	{
		Optional<IntegrationObjectItemModel> optionalIntegrationObjectItemModel = integrationObjectModel.getItems().stream()
																												   .filter(item -> item.getCode().equals(code))
																											       .findFirst();

		IntegrationObjectItemModel integrationObjectItemModel = optionalIntegrationObjectItemModel

...
public class IntegrationServicesOauth2UserFilter implements Filter
{
	...
	{
		return auth != null && auth instanceof OAuth2Authentication && ((OAuth2Authentication) auth).isClientOnly();
	}

	private IntegrationClientCredentialsDetailsModel findClientDetailsModel(final String principal) throws ModelNotFoundException
	{

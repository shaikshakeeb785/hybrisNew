...
class LocalizedAttributesPersistenceIntegrationTest extends ServicelayerTransactionalSpockSpecification {
    ...
    static final String NEW_ES_PRODUCT_NAME = "UPhone XI.es"
    static final String NEW_ES_PRODUCT_DESCRIPTION = "El último y más rápido UPhone es"
    static final String NEW_ES_CO_PRODUCT_NAME = "UPhone XI.es_CO"
    static final String NEW_ES_CO_PRODUCT_DESCRIPTION = "El último y más rápido UPhone es_CO"

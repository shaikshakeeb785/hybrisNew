...
{
	private static final String ERR_MSG = "The user lacks %s privileges for accessing the %s type.";
	 ...
	 *                   write, etc.
	 */
	public TypeAccessPermissionException(@NotNull final String itemType, @NotNull final String permission)
	{
	...
	{
		return String.format(ERR_MSG, permission, itemType);
	}
}

...
class WhereClauseBuilder
{
	...
	{
		final Optional<IntegrationObjectItemClassificationAttributeModel> classificationAttr =
				filter.getConditions().stream()
				      ...
				      .map(Optional::get)
				      .findFirst();
		if (classificationAttr.isPresent())
		{
			throw new FilterByClassificationAttributeNotSupportedException(classificationAttr.get());
		}
	}
	...
	{
		return attributeDescriptorModel.getIsSource()

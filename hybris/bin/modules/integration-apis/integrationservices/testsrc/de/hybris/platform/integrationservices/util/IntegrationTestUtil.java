...
public class IntegrationTestUtil extends ServicelayerTestLogic
{
	 ...
	 * @param item an item model to get fresh state for.
	 * @return fresh state of the specified model in the persitent storage.
	 */
	public static <T extends ItemModel> T refresh(final T item)
	{
		return getModelService().get(item.getPk());
	}

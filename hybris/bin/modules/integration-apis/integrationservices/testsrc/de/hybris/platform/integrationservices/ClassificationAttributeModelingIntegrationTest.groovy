...
class ClassificationAttributeModelingIntegrationTest extends ServicelayerSpockSpecification {
    ...
    @Test
    def 'classification attribute name must be different from attribute name'() {
        ...
        then:
        def e = thrown AssertionError
        e.message.contains 'The classification attribute [code] is used in an integration object item attribute'
    }
    ...
    def 'attribute name must be different from classification attribute name'() {
        ...
        then:
        def e = thrown AssertionError
        e.message.contains 'The attribute [depth] is used in an integration object item classification attribute'
    }

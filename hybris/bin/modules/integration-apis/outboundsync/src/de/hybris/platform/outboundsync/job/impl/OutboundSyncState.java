...
public final class OutboundSyncState
{
	...
	private OutboundSyncState(Integer allItems, Date started, int successes, int errors, int aborted, Date ended)
	{
		...
		Preconditions.checkArgument(aborted >= 0, "Number of items ignored after abort cannot be negative");

		totalItemsRequested = allItems;
		startTime = started;
		successCount = successes;
		errorCount = errors;
		unprocessedCount = aborted;
	...
	{
		return unprocessedCount > 0 ? CronJobStatus.ABORTED : CronJobStatus.FINISHED;
	}
	...
	public static final class Builder
	{
		...
		{
			return new OutboundSyncState(totalItemsRequested, startTime, successCount, errorCount, unprocessedCount, endTime);
		}
	}
}

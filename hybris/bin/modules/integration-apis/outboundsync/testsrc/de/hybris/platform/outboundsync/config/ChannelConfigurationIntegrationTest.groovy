...
class ChannelConfigurationIntegrationTest extends ServicelayerTransactionalSpockSpecification {
	...
	private static final String INTEGRATION_OBJECT_CODE = 'IntegrationObjectForChannelConfigTest'
	private static final String CHANNEL_CODE = 'ChannelConfigTest'
	...
	def setup() {
		consumedDestination = ConsumedDestinationBuilder.consumedDestinationBuilder().withId('channelConfig').build()

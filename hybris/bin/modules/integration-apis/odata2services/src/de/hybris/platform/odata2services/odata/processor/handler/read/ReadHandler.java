	...
	public ODataResponse handle(final ReadParam param) throws ODataException
	{
		try
		{
			...
			return augmentResponse(itemLookupRequest, readerResponse);
				...
				| TypeAttributeDescriptorNotFoundException | FilterByClassificationAttributeNotSupportedException
				| IntegrationKeyNestedFilteringNotSupportedException | TypeAccessPermissionException ex)
		{
			throw ex;
		}

...
public class InvalidEntryDataException extends PersistenceRuntimeApplicationException
{
	 ...
	 */
	public InvalidEntryDataException(final OData2ServicesException e, final StorageRequest storageRequest)
	{
		super(e.getMessage(), STATUS_CODE, e.getCode(), storageRequest.getIntegrationKey());
	}
}

...
public class ExpandPropertyPopulator implements ResponseWriterPropertyPopulator
{
	 ...
	 * Use setTypePermissionService instead
	 * */
	@Deprecated(since = "2005.2", forRemoval = true)
	public void setPermissionService(final AccessRightsService permissionService)
	{
		// Has been replaced with TypePermissionService
	}
}

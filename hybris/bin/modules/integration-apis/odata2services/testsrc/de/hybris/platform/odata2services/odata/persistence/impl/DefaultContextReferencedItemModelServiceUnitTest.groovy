...
class DefaultContextReferencedItemModelServiceUnitTest extends Specification {
    ...
    @Test
    def 'deriveReferencedItemModelCollection returns empty collection when the attribute value in the payload is empty'() {
    ...
    @Test
    def "deriveReferencedItemModelCollection throws exception when autocreate=false and partof=false and no existing item can be found"() {
        given: 'canCreateReferencedItem >> false'
    ...
    @Test
    def 'deriveReferencedItemModelCollection prefers items found in the context to an item existing in the platform'() {
        given: 'an attribute descriptor'
    ...
    @Test
    def 'deriveReferencedItemModelCollection returns an item existing in the platform when there is no item in the context'() {
        given: 'an attribute descriptor'
    ...
    @Test
    @Unroll
    def "deriveReferencedItemModelCollection creates new item when item is not found and the attribute has #attr=true"() {
    ...
    @Test
    def 'deriveReferencedItemModelCollection throws exception when context item retrieval throws exception'() {
        given: 'an attribute descriptor'
        def attribute = typeAttributeDescriptor()
    ...
    @Test
    def 'deriveReferencedItemModelCollection throws exception when found item cannot be set in the context'() {
        given: 'an attribute descriptor'
        def descriptor = typeAttributeDescriptor()

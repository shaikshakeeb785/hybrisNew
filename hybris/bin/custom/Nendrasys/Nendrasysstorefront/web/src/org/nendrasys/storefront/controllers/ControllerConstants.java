 ...
 */
package org.nendrasys.storefront.controllers;
...
public interface ControllerConstants {
	...
	interface Views {
		...
		interface Pages {
			interface ManufacturerData // NOSONAR
			{
				String data = "pages/manufacturerData/manufacturerDetailsPage"; // NOSONAR
				String list="pages/manufacturerData/listmanufacturerDetailsPage";
				String error="pages/manufacturerData/errorPage";
				String register="pages/manufacturerData/registerManufacturerDetailsPage";
			}
			interface CarouselData // NOSONAR
			{
				String data = "pages/CarouselData/customCarouselComponentDataPage"; // NOSONAR

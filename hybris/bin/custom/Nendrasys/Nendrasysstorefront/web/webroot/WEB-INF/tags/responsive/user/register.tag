...
<%--@elvariable id="userRegisterForm" type="org.nendrasys.storefront.model"--%>
<form:form method="post" modelAttribute="userRegisterForm" action="${action}">
    ...
    <formElement:formPasswordBox idKey="register.checkPwd"
                                 ...
                                 mandatory="true"/>
    <formElement:formCheckbox idKey="newBusinessUser" labelKey="newBusinessUser" path="newBusinessUser" mandatory="true"/>
    ...
    <template:errorSpanField path="termsCheck">
        <div class="checkbox">
            <label class="control-label uncased">
                <form:checkbox id="registerChkTermsConditions" path="termsCheck"/>
    ...
    <div class="form-actions clearfix">
        <ycommerce:testId code="register_Register_button">
            <button type="submit" class="btn btn-default btn-block" id="sendNewSms" disabled="disabled">

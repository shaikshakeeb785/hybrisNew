...
public class ImpExTranslatorTest extends AbstractImpExTest
{
	 ...
	 * Abbreviation for ",,".
	 */
	private static final String DELIMITERS = String.valueOf(ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER)
		...
		ATOMIC_TEST_DATA_IMPORT = new Object[][]
				{
						...
						{ BigDecimal.class, DEF_DOUBLE_FORMAT.format(new BigDecimal("1346134.6")), new BigDecimal(
								"1346134.6") } };
				...
				{
						{
								...
								"aaa" + ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER + "bbb  "
										...
										+ ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER + " ddd", Arrays.asList(
								new String[]
										{ "aaa", "bbb", "ccc", "ddd" }) },
								...
								Collections.EMPTY_LIST },
						{
								...
								ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER + "middle"
										+ ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER, Collections.singletonList(
								"middle") },

						{
								...
								"true" + ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER + "falSe"
										+ ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER + "false", Arrays.asList(
								new Object[]
										{ Boolean.TRUE, Boolean.FALSE, Boolean.FALSE }) },

						{ Integer.class, Character.valueOf(';'), // CORE-3378
								"123;;45678;91011;", Arrays.asList(new Object[]
								{ Integer.valueOf(123), Integer.valueOf(
										45678), Integer.valueOf(91011) }) },

						{ Double.class, Character.valueOf(';'), // CORE-3378
								";1,234 ; -567,89;  910,11 ;", Arrays.asList(new Object[]
								{ new Double(1.234), new Double(
										-567.89), new Double(910.11) }) },

						{
								Date.class, // CORE-4186
								Character.valueOf(ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER),
								DEF_DATE_FORMAT.format(
										new Date(1234567L * 1000L)) + ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER
		...
		COLLECTION_TEST_DATA_EXPORT = new Object[][]
				{
						...
						{ Integer.class,
								...
								DEF_INT_FORMAT.format(123) + ";" + DEF_INT_FORMAT.format(45678) + ";" + DEF_INT_FORMAT.format(
										91011),
	...
	public void testCollectionValueTranslatorImport()
	{
		...
		for (int i = 0; i < COLLECTION_TEST_DATA_IMPORT.length; i++)
		{
			...
			final CollectionValueTranslator cvt = new CollectionValueTranslator(collT, avt,
					((Character) testData[1]).charValue());
		...
		try
		{
			...
			collT = TypeManager.getInstance().createCollectionType("CollTransSetType",
					TypeManager.getInstance().getType("java.lang.Object"),
					CollectionType.SET);
			final AttributeDescriptor attributeDescriptor = testItemType.createAttributeDescriptor("set", collT,
					AttributeDescriptor.READ_FLAG
	...
	public void testItemPKTranslatorImport()
	{
		...
		final String delimiters = String.valueOf(ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER)
				+ ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER; // := '||'
		...
		assertEquals(Collections.singletonList(german),
				cvt.importValue(
						delimiters + german.getPK().toString() + ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER,
						null));
		assertEquals(
				Arrays.asList(new Object[]
						{ german, english }),
	...
	public void testItemPkTranslatorExport()
	{
		...
		final Collection collection1 = Arrays.asList(new Object[]
				{ deTest, enTest });
		assertEquals("working on:" + collection1.toString(),
				dePk + ImpExConstants.Syntax.DEFAULT_COLLECTION_VALUE_DELIMITER + enPk,
	...
	public void testItemExpressionTranslatorImport()
	{
		...
		try
		{
			final ItemExpressionTranslator itemExpressionTranslator = new ItemExpressionTranslator(
					TypeManager.getInstance().getComposedType(
	...
	public void testItemExpressionTranslatorExport()
	{
		...
		try
		{
			itemExpressionTranslator = new ItemExpressionTranslator(TypeManager.getInstance().getComposedType(Customer.class),
					patternList);
		}
	...
	public void testMapValueTranslatorExport()
	{
		...
		try
		{
			mapType = TypeManager.getInstance()
			                     .createMapType("myMapType", TypeManager.getInstance().getRootAtomicType(String.class),
					                     TypeManager.getInstance().getRootAtomicType(String.class));
		}
		catch (final JaloDuplicateCodeException e)
		{
	...
	public void testNestedDateFormatImport()
	{
		...
		try
		{
			...
			final ItemExpressionTranslator itemExpressionTranslator = new ItemExpressionTranslator(
					TypeManager.getInstance().getComposedType(Media.class),
					patternList);
	...
	public void testNestedDateFormatExport()
	{
		...
		try
		{
			itemExpressionTranslator = new ItemExpressionTranslator(TypeManager.getInstance().getComposedType(Media.class),
					patternList);
			itemExpressionTranslator.init(null);
		}
		catch (final HeaderValidationException e1)

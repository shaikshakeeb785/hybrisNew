...
public class PLA_12491_Test extends ServicelayerBaseTest
{
	...
	protected PLA_12491_Test_Interceptor assertInterceptorInstalled()
	{
		...
		fail("PLA_12491_Test_Interceptor not installed! - got " + interceptorRegistry.getValidateInterceptors(
				TitleModel._TYPECODE)
				+ " instead");
		return null;
	}
	...
	static class TestMTIR extends MultiThreadedImpExImportReader
	{
		...
		TestMTIR(final String lines, final int threads, final int errorLineNr, final String errorCode,
		         boolean simulateWorkerError)
		{
			super(lines);

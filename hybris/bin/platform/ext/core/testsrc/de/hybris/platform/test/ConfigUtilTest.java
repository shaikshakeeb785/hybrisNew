...
public class ConfigUtilTest
{
	...
	public void testExpandProperties()
	{
		...
		assertTrue(TEST_PROPERTY_2 + " was " + tempProps.getProperty(TEST_PROPERTY_2) + " when expected value was "
						+ (TEST_PROPERTY + SOME_CONTENT),
				(TEST_PROPERTY + SOME_CONTENT).equals(tempProps.getProperty(TEST_PROPERTY_2)));
		...
		assertTrue(TEST_PROPERTY_4
						...
						+ (TEST_PROPERTY + SOME_CONTENT + SOME_MORE_CONTENT + " " + tempProps.getProperty(
				TEST_PROPERTY_1) + " ${"
						+ UNRESOLVED_PROPERTY + "}"),

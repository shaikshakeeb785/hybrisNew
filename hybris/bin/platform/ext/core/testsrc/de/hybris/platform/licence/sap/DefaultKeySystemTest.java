...
public class DefaultKeySystemTest
{
	...
	{
		assertThat(defaultKeySystem.getSwProducts()).containsOnly("CPS_HDB", "CPS_SQL", "CPS_ORA", "CPS_MSS", "CPS_MYS",
				"CPS_POS");
	}
	...
	public void shouldContainProductNamesWithConfiguredDbPostfixes() throws Exception
	{
		...
		// then
		assertThat(swProducts).containsOnly("CPS_SAPTEST", "CPS_MYSQLTEST", "CPS_ORACLETEST", "CPS_SQLSERVERTEST",
				"CPS_HSQLDBTEST",
				"CPS_POSTGRESQLTEST");
	}

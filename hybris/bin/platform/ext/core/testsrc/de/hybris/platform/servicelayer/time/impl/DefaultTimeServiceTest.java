...
public class DefaultTimeServiceTest extends ServicelayerBaseTest
{
	...
	public void testSetCurrentTime()
	{
...

		{
			...
			// since we're setting the offset indirectly via Date it may not be exact!
			assertTrue("expecting current offset to be <= offset after setting future time",
					timeService.getTimeOffset() <= offset);
...

		{
			...
			assertTrue("expecting real current offset to be > 50% offset after setting future time",
					realCurrentOffset > offset / 2);
		}

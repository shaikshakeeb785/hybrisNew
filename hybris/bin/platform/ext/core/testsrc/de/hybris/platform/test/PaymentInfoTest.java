...
public class PaymentInfoTest extends HybrisJUnit4TransactionalTest
{
			...
			JaloAbstractTypeException
	{
		...
		final EnumerationValue dinertype = EnumerationManager.getInstance()
		                                                     .getEnumerationValue(Constants.TYPES.CreditCardTypeType,
				                                                     "diners");
		...
		{
			assertEquals("", "The CreditCard number is not a valid VISA creditcard number!", e.getMessage());
		}
		...
		{
			assertEquals("", "The CreditCard number is not a valid AmericanExpress creditcard number!", e.getMessage());
		}
		...
		{
			assertEquals("", "The CreditCard number is not a valid Diners creditcard number!", e.getMessage());
		}
		...
		{
			assertEquals("", "The CreditCard number is not a valid Master creditcard number!", e.getMessage());
		}
	}

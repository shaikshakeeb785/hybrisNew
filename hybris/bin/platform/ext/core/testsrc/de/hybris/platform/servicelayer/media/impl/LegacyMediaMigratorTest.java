...
public class LegacyMediaMigratorTest extends ServicelayerBaseTest
{
	...
	{
		return flexibleSearchService.search(
				"SELECT {" + MediaModel.PK + "} FROM {" + MediaModel._TYPECODE + "} WHERE {" + MediaModel.MIME + "}='_'")
		                            .getResult();
	}
	...
	{
		return flexibleSearchService.search(
				"SELECT {" + MediaModel.PK + "} FROM {" + MediaModel._TYPECODE + "} WHERE {" + MediaModel.REALFILENAME + "}='_'")
		                            .getResult();
	}

...
public class PersistenceTestUtils
{
	 ...
	 *
	 * @param modelService model service for item saving
	 * @param item         item to save
	 */
	public static <T extends AbstractItemModel> void saveAndVerifyThatPersistedThroughSld(final ModelService modelService,
	                                                                                      final T item)
	{

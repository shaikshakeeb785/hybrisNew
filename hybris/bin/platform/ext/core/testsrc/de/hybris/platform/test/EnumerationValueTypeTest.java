...
public class EnumerationValueTypeTest extends HybrisJUnit4TransactionalTest
{
	...
	{
		final ComposedType colorEnumerationValueType = enumerationManager.createDefaultEnumerationType(
				"colorEnumerationValueType");
		/* conv-log */
		log.debug("EnumerationValueTypeTest before remove");
	...
	public void testCreateEnumerationValueType() throws Exception
	{
		// create
		/* conv-log */
		log.debug("EnumerationValueTypeTest before remove222");

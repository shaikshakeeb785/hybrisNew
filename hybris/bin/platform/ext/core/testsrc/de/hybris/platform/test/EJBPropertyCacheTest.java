		...
		try
		{
			...
			try
			{
				final TestItemHome home = (TestItemHome) Registry.getCurrentTenant().getPersistencePool()
				                                                 .getHomeProxy(Registry.getPersistenceManager()
				                                                                       .getJNDIName(Constants.TC.TestItem));
				item = home.create();
				...
				final ComposedTypeRemote testItemType2 = SystemEJB.getInstance()
				                                                  .getTypeManager()
				                                                  .getComposedType("TestItemType2");
				try
				{

...
public class OrderDemoTest extends ServicelayerBaseTest implements AuditableTest
{
	...
	public void shouldAuditOrdersAndEntries_showEntries()
	{
		...
		final List<ReportView> u1ReportView = auditViewService
				.getViewOn(
						TypeAuditReportConfig.builder()
						                     ...
						                     .withRootTypePk(order.getPk())
						                     .withFullReport()
						                     .build())
				.collect(toList());


		final Map<String, List<Map<String, String>>> orderReport0 = (Map<String, List<Map<String, String>>>) u1ReportView.get(0)
		                                                                                                                 .getPayload()
		                                                                                                                 .get(ORDER);
		assertThat(orderReport0.get(ENTRIES).size()).isEqualTo(0);

		final Map<String, List<Map<String, Object>>> orderReport1 = (Map<String, List<Map<String, Object>>>) u1ReportView.get(1)
		                                                                                                                 .getPayload()
		                                                                                                                 .get(ORDER);
		...
		final Map<String, List<Map<String, Object>>> orderReport2 = (Map<String, List<Map<String, Object>>>) u1ReportView.get(2)
		                                                                                                                 .getPayload()
		                                                                                                                 .get(ORDER);

...
public class PropertyTableDefinitionTest
{
	...
	public void testGetColumnDefinitionCaseUnAware()
	{
		...
		Assert.assertEquals(SOME_DEFINITION,
				definition.getSqlColumnDescription("colUmnNaMewItHBig".toLowerCase(), localizedFlag));
		Assert.assertEquals(COLUMN_QUALIFIER_2,
				definition.getColumnPropertyName("colUmnNaMewItHBig".toLowerCase(), localizedFlag));
		...
		Assert.assertEquals(SOME_DEFINITION,
				definition.getSqlColumnDescription("colUmnNaMewItHBig".toUpperCase(), localizedFlag));
		Assert.assertEquals(COLUMN_QUALIFIER_2,
				definition.getColumnPropertyName("colUmnNaMewItHBig".toUpperCase(), localizedFlag));
	}
	...
	public void testAddAmbiguityColumn()
	{
		...
		definition.addColumn(COLUMN_QUALIFIER_2, "columnNameWITHBig", String.class, SOME_DEFINITION, !localizedFlag,
				true);//ok not localized
	...
	{
		definition.addColumn(COLUMN_QUALIFIER_1, SOME_LONG_DESCRIPTOR, String.class, SOME_DEFINITION, NON_LOCALIZED,
				true);//prepare
	...
	{
		definition.addColumn(COLUMN_QUALIFIER_1, SOME_LONG_DESCRIPTOR, Object.class, SOME_DEFINITION, NON_LOCALIZED,
				true);//prepare
	...
	{
		definition.addColumn(COLUMN_QUALIFIER_1, SOME_SHORT_DESCRIPTOR, Object.class, SOME_DEFINITION, NON_LOCALIZED,
				true);//prepare

...
public class NumberSeriesPerformanceTest extends HybrisJUnit4Test
{
	...
	public void setUp() throws Exception
	{
		...
		numberSeriesManager.createNumberSeries(SERIES1, "034",
				NumberGenerator.NumberSeriesConstants.TYPES.NUMERIC); // digits = 3 this way
		numberSeriesManager.createNumberSeries(SERIES2, "1ZY", NumberGenerator.NumberSeriesConstants.TYPES.ALPHANUMERIC,
				DECIMALS);
	}

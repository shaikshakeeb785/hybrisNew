...
public class AbstractOrderCalculationTest extends HybrisJUnit4TransactionalTest
{
	...
	public void testCalculation() throws JaloPriceFactoryException
	{
		...
		/*
		 * give entries prices 10 x 1.234 = 12.340 , 16% VAT FULL 3 x 3.333 = 9.999 , 7% VAT HALF, -0.999 DISC A, - 10% DISC B =
		 * 8.100
		 */
		oe1.setQuantity(10);
		...
		oe2.setDiscountValues(Arrays.asList(new Object[]
				{ new DiscountValue("DISC A", 0.333, true,
						curr.getIsoCode()), new DiscountValue("DISC B", 10, false,
						null) }));
		...
		/*
		 * now calculate and check order: 10 x 10 x 1.234 , 16% VAT FULL = 12.340 3 x 3.333 = 9.999 , 7% VAT HALF, -3 x 0.333 =
		 * -0.999 DISC A, - (10%,0.900) DISC B = 8.100 -------- subtotal = 20,440 VAT FULL 16% = 1,974 VAT HALF 7% = 0,567 taxes
		 * = 2,541 discounts = 0,000 total = 20.440
		 */
		o.calculateTotals(false);
		...
		/*
		 * test global discount subtotal = 20,440 ----------- - 10% -> -2.044 = 18,396 - 3 -> -3 = 15,396 -5% -> 0,770 = 14,626
		 * discounts = 5,814 ----------- (internal) tax factor = 14,626 / 20,440 = 0,71555772994129158512720156555773
		 * ----------- VAT FULL 16% = 1,413 VAT HALF 7% = 0,406 taxes = 1,819 total = 14,626
		 */
		...
		checkOrder(o, 20.440, // subtotal
				...
				Arrays.asList(new Object[]
						{ new DiscountValue("10%off", 10, false, 2.044, null), new DiscountValue("3off", 3, true,
								3.0,
								curr.getIsoCode()),
		...
		/*
		 * add payment and delivery costs subtotal = 20,440 ----------- - 10% -> -2.044 = 18,396 - 3 -> -3 = 15,396 -5% -> 0,770
		 * = 14,626 discounts = 5,814 ----------- delivery = 4,44 payment = 2,222 ----------- (internal) tax factor = ( 14,626 +
		 * 4,44 + 2,222 ) / 20,440 = 1,0414872798434442270058708414873 ----------- VAT FULL 16% = 2,056 VAT HALF 7% = 0,591
		 * taxes = 2,647 total = 21,288
		 */

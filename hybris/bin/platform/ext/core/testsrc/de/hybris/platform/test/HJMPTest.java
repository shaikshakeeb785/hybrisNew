...
public class HJMPTest extends HybrisJUnit4Test
{
	...
	public void testMoveDumpProps()
	{
		...
		try
		{
			...
			OldPropertyJDBC.moveDumpData(Constants.TC.TestItem, propName,
					Registry.getPersistenceManager()
					        .getItemDeployment(Constants.TC.TestItem)
	...
	public void testWriteReadValues()
	{
		...
		/* conv-LOG */
		LOG.debug(">>> BigDecimal (" + bigDecimalValue + ")<<<");
		...
		/* conv-LOG */
		LOG.debug(">>> Timestamp (" + timestamp + ", ms=" + timestamp.getTime() + ")<<<");
		remote.setDate(timestamp);
		final java.util.Date got2 = remote.getDate();
		/* conv-LOG */
		LOG.debug(">>> found (" + got2.getTime() + ")<<<");
		...
		/* conv-LOG */
		LOG.debug(">>> boolean (" + booleanValue2 + ") <<<");
		...
		/* conv-LOG */
		LOG.debug(">>> char (" + characterValue2 + ") <<<");
		...
		{
			/* conv-LOG */
			LOG.debug(">>> Search ( " + str + ", " + integerValue2 + " ) <<<");
	...
	public void testNumericWriteReadValuesRounding()
	{
		...
		/* conv-LOG */
		LOG.debug(">>> FloatOverValue (" + floatOverValue + ") <<<");
		...
		/* conv-LOG */
		LOG.debug(">>> DoubleOverValue (" + doubleOverValue + ") <<<");
		...
		/* conv-LOG */
		LOG.debug(">>> BigDecimalOverValue (" + bigDecimalOverValue + ")<<<");

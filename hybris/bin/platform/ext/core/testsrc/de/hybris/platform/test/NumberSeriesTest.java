...
public class NumberSeriesTest extends HybrisJUnit4Test
{
	...
	public void setUp() throws Exception
	{
		...
		numberSeriesManager.createNumberSeries(SERIES1, "034", NumberGenerator.NumberSeriesConstants.TYPES.NUMERIC, -1,
				null); // digits = 3 this way
	...
	public void testTA()
	{
		try
		{
			...
			try
			{
				series = numberSeriesManager.createNumberSeries(SERIES3, "0010",
						NumberGenerator.NumberSeriesConstants.TYPES.NUMERIC,
						4);

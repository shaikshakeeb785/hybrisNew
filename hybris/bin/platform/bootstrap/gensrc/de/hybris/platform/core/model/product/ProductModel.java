...
public class ProductModel extends ItemModel
{
	...
	/**<i>Generated relation code constant for relation <code>ManufacturerToProduct</code> defining source attribute <code>manufacturerDetails</code> in extension <code>Nendrasyscore</code>.</i>*/
	public static final String _MANUFACTURERTOPRODUCT = "ManufacturerToProduct";
	...
	/** <i>Generated constant</i> - Attribute key of <code>Product.newProduct</code> attribute defined at extension <code>Nendrasyscore</code>. */
	public static final String NEWPRODUCT = "newProduct";
	
	/** <i>Generated constant</i> - Attribute key of <code>Product.manufacturerDetails</code> attribute defined at extension <code>Nendrasyscore</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.manufacturerDetails</code> attribute defined at extension <code>Nendrasyscore</code>. 
	 * @return the manufacturerDetails
	 */
	@Accessor(qualifier = "manufacturerDetails", type = Accessor.Type.GETTER)
	public Collection<ManufacturerDetailsModel> getManufacturerDetails()
	{
		return getManufacturerDetails(null);
	}
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.manufacturerDetails</code> attribute defined at extension <code>Nendrasyscore</code>. 
	 * @param loc the value localization key 
	 ...
	 */
	@Accessor(qualifier = "manufacturerDetails", type = Accessor.Type.GETTER)
	public Collection<ManufacturerDetailsModel> getManufacturerDetails(final Locale loc)
	{
		return getPersistenceContext().getLocalizedRelationValue(MANUFACTURERDETAILS, loc);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.newProduct</code> dynamic attribute defined at extension <code>Nendrasyscore</code>. 
	 * @return the newProduct - status of the product.
	 */
	@Accessor(qualifier = "newProduct", type = Accessor.Type.GETTER)
	public Boolean getNewProduct()
	{
		return getPersistenceContext().getDynamicValue(this,NEWPRODUCT);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.manufacturerDetails</code> attribute defined at extension <code>Nendrasyscore</code>. 
	 *  
	 * @param value the manufacturerDetails
	 */
	@Accessor(qualifier = "manufacturerDetails", type = Accessor.Type.SETTER)
	public void setManufacturerDetails(final Collection<ManufacturerDetailsModel> value)
	{
		setManufacturerDetails(value,null);
	}
	/**
	 * <i>Generated method</i> - Setter of <code>Product.manufacturerDetails</code> attribute defined at extension <code>Nendrasyscore</code>. 
	 *  
	 ...
	 */
	@Accessor(qualifier = "manufacturerDetails", type = Accessor.Type.SETTER)
	public void setManufacturerDetails(final Collection<ManufacturerDetailsModel> value, final Locale loc)
	{
		getPersistenceContext().setLocalizedValue(MANUFACTURERDETAILS, loc, value);
	}
